...
-- Specify the plugins to install using lazy.nvim
  ...
  -- DAP UI (optional, for visual debugging)
  {
    "rcarriga/nvim-dap-ui",
    lazy = true,  -- Lazy load DAP UI
    config = function()
      require('dapui').setup()
    end
  },

  -- nvim-dap-python (Python-specific configuration)
  {
    "mfussenegger/nvim-dap-python",
    lazy = true,  -- Lazy load nvim-dap-python
    config = function()
      require('dap-python').setup('/opt/anaconda3/bin/python3')  -- Adjust path if needed
    end
  },
}
